...
module.exports = function () {
  ...
  this.When(/^I click the plus sign in the shopping cart$/, async function() {
    quantityBeforeChange = +(await (await driver.findElement(By.css('div[class^="product-quantity-sm selenium--mini-cart-quantity"]>div[class="ax-product-quantity-instock"]>form[class^="ax-product-quantity-input"]>input[name="quantity"]'))).getAttribute("value"));
  ...
  this.When(/^I change the number directly in quantity to a random number$/, async function() {
    ...
    let quantityInput = await driver.findElement(By.css('div[class^="product-quantity-sm selenium--mini-cart-quantity"]>div[class="ax-product-quantity-instock"]>form[class^="ax-product-quantity-input"]>input[name="quantity"]'));
  ...
  this.Then(/^the quantity should change$/, async function() {
    let newQuantity = +(await (await driver.findElement(By.css('div[class^="product-quantity-sm selenium--mini-cart-quantity"]>div[class="ax-product-quantity-instock"]>form[class^="ax-product-quantity-input"]>input[name="quantity"]'))).getAttribute("value"));
  ...
  this.Then(/^the quantity should remain the same as before$/, async function () {
    let quantity = +(await (await driver.findElement(By.css('div[class^="product-quantity-sm selenium--mini-cart-quantity"]>div[class="ax-product-quantity-instock"]>form[class^="ax-product-quantity-input"]>input[name="quantity"]'))).getAttribute("value"));
    await waitAWhile(true);
